...
class MaterialReportWizard(models.TransientModel):
    ...
    def material_excel_report(self):
        ...
        return self.env.ref('wifiber.material_report').report_action(self,data)
