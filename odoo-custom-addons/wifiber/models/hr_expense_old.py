...
class HRExpense(models.Model):
    ...
    def _get_url(self, module_name, menu_id, action_id, context=None):
        ...
        fragment['model'] = 'hr.expense.group.wifiber'
    ...
    def action_view_exp_group(self):
        ...
        action = imd.xmlid_to_object('wifiber_modifications.action_hr_expense_group_wifiber')
        list_view_id = imd.xmlid_to_res_id('hr_expense_group_tree_view_wifiber')
        form_view_id = imd.xmlid_to_res_id('hr_expense_group_form_view_wifiber')
    ...
    def submit_expenses(self):
        ...
        the_url = self._get_url('wifiber', 'menu_hr_expense_group_wifiber', 'action_hr_expense_group_wifiber',ctx)
        mail_template = self.env.ref('wifiber.mail_templ_submit_expense_wifiber')
    ...
    def refuse_expenses(self, reason):
        ...
        ctx.update({'expense_group_id': self.expense_group_id.id})
        the_url = self._get_url('wifiber', 'menu_hr_expense_group_wifiber', 'action_hr_expense_group_wifiber', ctx)
        mail_template = self.env.ref('wifiber.mail_templ_refuse_wifiber')
    ...
    def paid_expenses(self):
        ...
        ctx.update({'expense_group_id': self.expense_group_id.id})
        the_url = self._get_url('wifiber', 'menu_hr_expense_group_wifiber', 'action_hr_expense_group_wifiber', ctx)
        mail_template = self.env.ref('wifiber.mail_templ_paid_wifiber')
    ...
    def approve_expenses(self):
        ...
        #  send email
        # user_ids = []
        # group_obj = self.env.ref('wifiber.group_wifiber_expense_auditor_wifiber')
        # user_names = ''
        ...
        the_url = self._get_url('wifiber', 'menu_hr_expense_group_wifiber', 'action_hr_expense_group_wifiber', ctx)
        mail_template = self.env.ref('wifiber.mail_templ_approve_expense_wifiber')
    ...
    def audit_approve(self):
        ...
        ctx.update({'expense_group_id': self.expense_group_id.id})
        the_url = self._get_url('wifiber', 'menu_hr_expense_group_wifiber', 'action_hr_expense_group_wifiber', ctx)
        mail_template = self.env.ref('wifiber.mail_templ_audit_approve_expense_wifiber')
    ...
    def action_move_create(self):
        ...
        ctx.update({'expense_group_id': self.expense_group_id.id})
        the_url = self._get_url('wifiber', 'menu_hr_expense_group_wifiber', 'action_hr_expense_group_wifiber', ctx)
        mail_template = self.env.ref('wifiber.mail_templ_post_expense_wifiber')
    ...
    expense_type_id = fields.Many2one('wifiber.expense.type',string='Expense Type')
    exp_group_count = fields.Integer(compute="_compute_exp_group_count", string='# of Expense Groups', copy=False, default=0)
    expense_group_id = fields.Many2one('hr.expense.group.wifiber',string='Expense Group')
    ...
    company = fields.Selection([('wifiber', 'wifiberTech'),
                              ('fob', 'FOB')
...
class HRExpenseGroup(models.Model):
    _name = 'hr.expense.group.wifiber'
