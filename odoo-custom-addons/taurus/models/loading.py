...
# Copyright 2023 - 2023  Kinsolve Solutions
# Copyright 2023 - 2023 Kingsley Okonkwo (kingsley@kinsolve.com, +2348030412562)
...
class StockPicking(models.Model):
    ...
    def btn_print_loading_ticket(self):
        ...
        return self.env.ref('taurus.action_report_loading_ticket_taurus').report_action(self)
    ...
    def btn_print_waybill(self):
        ...
        return self.env.ref('taurus.action_report_delivery_taurus').report_action(self)
...
class PurchaseOrder(models.Model):
    ...
    def btn_request_approval(self):
        ...
        if self.is_purchase :
            ...
            self.send_grp_email(grp_name='taurus.group_purchase_order_receive_request_approval_email_procurement', subject=msg,msg=msg)
