...
class PurchaseLinesReportWizard(models.TransientModel):
    _name = 'purchase.lines.report.wizard'
    ...
    def purchase_lines_excel_report(self):
        ...
        return self.env.ref('kin_purchase.purchase_lines_report').report_action(self, data)


    start_date = fields.Datetime('Start Date')
    end_date = fields.Datetime('End Date')
    partner_id = fields.Many2one('res.partner',string='Supplier')
    product_ids = fields.Many2many('product.product', 'purchase_lines_lines_rel', 'purchase_lines_wizard_id', 'prod_id', string='Products')
