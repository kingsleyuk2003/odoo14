...
class OutstandingStatementWizard(models.TransientModel):
    ...
    def send_mass_email_outstanding_statement(self,partners):
        ...
        for partner in partners:
            ...
            if company_email and partner_email:
                mail_template = partner.env.ref('kin_account.mail_template_partner_outstanding_statement_email')
    ...
    def action_statement_send(self):
        ...
        if len(partner_id) > 1 :
            ...
            self.send_mass_email_outstanding_statement(partners)

        else:
            template_id = self.env['ir.model.data'].xmlid_to_res_id('kin_account.mail_template_partner_outstanding_statement_email', raise_if_not_found=False)
